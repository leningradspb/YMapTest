...
@class YMKRoadEventsLayerHighlightCircleStyle;
 ...
 * Undocumented
 */
typedef NS_ENUM(NSUInteger, YMKRoadEventsLayerHighlightMode) {
    /**
     * Undocumented
     */
    YMKRoadEventsLayerHighlightModeSoftPulsation,
    /**
     * Undocumented
     */
    YMKRoadEventsLayerHighlightModeHardPulsation
};
 ...
 * Undocumented
 */
- (nullable YMKRoadEventsLayerHighlightCircleStyle *)provideHighlightCircleStyleWithIsNightMode:(BOOL)isNightMode
                                                                                  highlightMode:(YMKRoadEventsLayerHighlightMode)highlightMode;
 ...
 */
@property (nonatomic) CGPoint pulsationCenter;
